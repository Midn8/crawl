...
{ // Dungeon (OOD cap: 27)
  ...
  {  5, 10,  450, FLAT, MONS_WHITE_IMP },
  {  5, 10,  350, FLAT, MONS_UFETUBUS },
  {  5, 10,  300, FLAT, MONS_SHADOW_IMP },
  ...
  {  5, 15,  215, PEAK, MONS_WATER_MOCCASIN },
  {  5, 16, 1000, FLAT, MONS_ZOMBIE },
  {  6, 13,  310, SEMI, MONS_BLACK_BEAR },
  {  6, 16, 1025, FLAT, MONS_BULLFROG },
  ...
  { 10, 16,  220, PEAK, MONS_SOLDIER_ANT },
  { 10, 18,  370, SEMI, MONS_GARGOYLE },
  { 10, 18,  500, SEMI, MONS_WRAITH },
  { 10, 20,  515, SEMI, MONS_UNSEEN_HORROR },
  { 10, 20,  215, PEAK, MONS_KOMODO_DRAGON },
  { 11, 15, 1100, FLAT, MONS_NO_MONSTER }, // Old imp weight.
...
{ // Swamp
  ...
  {  1,  4,   400, FLAT, MONS_KITSUNE },
  {  1,  4,   400, RISE, MONS_KITSUNE },
  ...
  {  1,  4,   600, FLAT, MONS_GOLIATH_FROG },
  {  1,  4,   400, RISE, MONS_GOLIATH_FROG },
  // Top-tier threats:
  {  1,  4,   25, FLAT, MONS_THORN_HUNTER },
  {  1,  4,  100, RISE, MONS_THORN_HUNTER },
  {  1,  4,   25, FLAT, MONS_SHAMBLING_MANGROVE },
  {  1,  4,  100, RISE, MONS_SHAMBLING_MANGROVE },
  {  1,  4,   25, FLAT, MONS_DEVOURING_SWARM },
  {  1,  4,  100, RISE, MONS_DEVOURING_SWARM },
  {  1,  4,   20, FLAT, MONS_FENSTRIDER_WITCH },
  {  1,  4,   95, RISE, MONS_FENSTRIDER_WITCH },
  {  1,  4,    5, FLAT, MONS_TENTACLED_MONSTROSITY },
  {  1,  4,    5, RISE, MONS_TENTACLED_MONSTROSITY },
  // OODs
  {  5,  7, 1000, FLAT, MONS_FENSTRIDER_WITCH },
  {  5,  7, 1000, FLAT, MONS_SHAMBLING_MANGROVE },
  {  5,  7, 1000, FLAT, MONS_THORN_HUNTER },

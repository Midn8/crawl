...

{
    ...
    M_NO_ZOMBIE,
    MR_RES_COLD,
    8, MONS_GHOUL, MONS_BLOATED_HUSK, MH_UNDEAD, 40,
...
// alligators, testudines, and crabs ('t')
{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    7, MONS_GIANT_LIZARD, MONS_ALLIGATOR, MH_NATURAL, 40,
...
{
    MONS_DEVOURING_SWARM, 'y', RED, "devouring swarm",
    M_NO_SKELETON | M_FLIES | M_BATTY,
    MR_VUL_POISON,
    3, MONS_DEVOURING_SWARM, MONS_DEVOURING_SWARM, MH_NATURAL, 100,
    { {AT_BITE, AF_PLAIN, 32}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 400,
    4, 22, MST_DEVOURING_SWARM, false, S_BUZZ,
    I_ANIMAL, HT_LAND, 25, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED,
    {TILEP_MONS_DEVOURING_SWARM}, TILE_ERROR
},
...
{
    MONS_WORKER_ANT, 'B', RED, "worker ant",
    M_NO_SKELETON,
    MR_VUL_POISON,
...
{
    MONS_QUEEN_ANT, 'B', LIGHTRED, "queen ant",
    M_NO_SKELETON,
    MR_VUL_POISON,
...
{
    MONS_SOLDIER_ANT, 'B', WHITE, "soldier ant",
    M_NO_SKELETON,
    MR_VUL_POISON,
...

{
    ...
    13, MONS_FROG, MONS_GOLIATH_FROG, MH_NATURAL, 80,
    { { AT_HIT, AF_REACH_TONGUE, 30 }, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 600,
    10, 15, MST_NO_SPELLS, true, S_SILENT, // IRL, goliath frogs have no vocals!
    I_ANIMAL, HT_AMPHIBIOUS, 14, SWIM_ENERGY(6),
...
{
    MONS_KITSUNE, 'H', YELLOW, "kitsune",
    M_SPEAKS | M_WARM_BLOOD | M_SEE_INVIS,
    MR_NO_FLAGS,
    10, MONS_KITSUNE, MONS_KITSUNE, MH_NATURAL, 140,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 440,
    4, 12, MST_KITSUNE, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_KITSUNE}, TILE_ERROR
},

{
    ...
    { { AT_KICK, AF_PLAIN, 25 }, { AT_KICK, AF_PLAIN, 25 }, AT_NO_ATK, AT_NO_ATK },
    16, 640,
    3, 14, MST_FENSTRIDER_WITCH, true, S_SHOUT,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_GIANT, MON_SHAPE_HUMANOID,
